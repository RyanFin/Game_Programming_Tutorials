...
int main(){
	...
	cout << "a large group of " << adventurers << "set out on a quest -- in search of the lost treasure of Ancient Dwarves." << 
	...
	(adventurers - killed) << " remaining in the group." <<endl;
	
	cout << "\nThe party was about to give up all hope. But whilst leaving the deceased to rest, they stumbled upon the buried fortune" <<
	"So the adventurers split 900 gold pieces." << leader << " held on to the extra four pieces to keep things fair of course." << endl;
